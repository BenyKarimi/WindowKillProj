...
public class OmenoctEnemyView {
    private final String id;
    private Point2D currentCenter;
    private double currentSize;
    public static ArrayList<OmenoctEnemyView> omenoctEnemyViewList = new ArrayList<>();

    public OmenoctEnemyView(String id) {
        this.id = id;
        currentCenter = new Point2D.Double(0, 0);
        omenoctEnemyViewList.add(this);
    }
